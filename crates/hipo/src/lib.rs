...
pub use crate::event::{Bank, Composite, Event, EventCtx, OwnedEvent, RowView};
...
///     let p = hipo::or_break!(rec.bank("REC::Particle"));
...
/// ```ignore
/// #[global_allocator]
/// static GLOBAL: hipo::mimalloc::MiMalloc = hipo::mimalloc::MiMalloc;
/// ```
///
