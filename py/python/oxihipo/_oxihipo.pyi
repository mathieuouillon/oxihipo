...
class Chain:
    ...
    def read_columns_at(
        self, selection: _Selection, entries: Sequence[int], threads: int = ...
    ) -> list[_BankColumns]: ...
    def event_tags(
        self,
        entry_start: int | None = ...,
    ...
    def user_config(self) -> list[tuple[str, str]]: ...
    def record_count(self) -> int: ...
    def file_header(
        self,
    ) -> tuple[int, int, int, str, bool, bool, int, int, int, int] | None: ...
    def bank_ids(self) -> list[tuple[str, tuple[int, int]]]: ...
    def composite_columns(
        self,
        bank: str,
        entry_start: int | None = ...,
        entry_stop: int | None = ...,
    ) -> tuple[NDArray[np.int64], list[tuple[str, NDArray[Any]]]]: ...
    def filtered(
        self,
    ...
    def skim(
        ...
        dst: str,
        compression: str = ...,
        tags: NDArray[np.uint32] | None = ...,
        tag_names: Sequence[tuple[str, int]] | None = ...,
    ) -> dict[str, int]: ...
